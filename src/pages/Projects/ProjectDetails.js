...
const ProjectDetails = () => {
    ...
    return (
        <section id='project-details' style={{flexDirection: 'column', margin: '0 auto', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
            <Box sx={{ minWidth: '95vw', maxWidth: '95vw', textAlign: 'center', py: 4, backgroundColor: '#f0f0f0', marginTop: '10px', borderRadius: '15px', boxShadow: '0px 4px 10px rgba(0, 0, 0, 0.1)', mb: 6}}>
        ...
        <Box sx={{minWidth: '95vw', maxWidth: '95vw', textAlign: 'center', backgroundColor: '#f0f0f0', borderRadius: '15px', boxShadow: '0px 4px 10px rgba(0, 0, 0, 0.1)', mb: 6}}>
            ...
            <Box sx={{variant: 'contained', minWidth: '95vw', maxWidth: '95vw', textAlign: 'center', backgroundColor: '#f0f0f0', borderRadius: '15px', boxShadow: '0px 4px 10px rgba(0, 0, 0, 0.1)', mb: 6 }}>

        ...
        <Box sx={{textAlign: 'center', backgroundColor: '#f0f0f0', borderRadius: '15px', boxShadow: '0px 4px 10px rgba(0, 0, 0, 0.1)', mb: 6 }}>
                ...
                <div style={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                    ...
                    {project.blurbs.map((blurb, index) => (
                        <zero-md class={currentBlurbIndex === index ? "slide" : "slide-hidden"} src={blurb.link} style={{textAlign: 'left', padding: '15px', fontSize:20, lineHeight: 1.6, maxWidth: '80%', background: 'white', color: 'black'}}></zero-md>
                    ))}

            ...
            <Box sx={{textAlign: 'center', backgroundColor: '#f0f0f0', borderRadius: '15px', boxShadow: '0px 4px 10px rgba(0, 0, 0, 0.1)', mb: 6 }}>
                ...
                <div style={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                    ...
                    {project.blurbs.map((blurb, index) => (
                        <div style={{borderRadius: '0.5rem', boxShadow: '0px 0px 7px #666', maxWidth: '80%', maxHeight: '400px'}}>
                            <p className={currentBlurbIndex === index ? "slide" : "slide-hidden"} style={{ textAlign: 'left', padding: '15px', fontSize:18, lineHeight: 1.6}}>{currentCarouselText}</p>
                        </div>
                    ))}

...
const ProjectDetails = () => {
    ...
    return (
        <section id='project-details'>
            <Box sx={{ minWidth: '80vh', display: 'flex', textAlign: 'center', py: 4, backgroundColor: '#f0f0f0', marginTop: '10px', borderRadius: '15px', boxShadow: '0px 4px 10px rgba(0, 0, 0, 0.1)', mb: 6}}>
